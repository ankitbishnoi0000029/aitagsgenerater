...
import { deafultTags, instagramFAQ } from '@/src/store/data';
...
export default function Page() {
    ...
    const generateTags = async () => {
        ...
        try {
            const res = await fetch('/api/instagram-tags', {
                method: 'POST',
            ...
            if (data.tags?.length > 0) {
                setTags(data.tags);
                showToast("🔥 Instagram Tags Generated!", "success");
            } else {
        ...
        <div className="bg-black text-white min-h-screen px-4">
            ...
            <div className="text-center mt-12 max-w-3xl mx-auto">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-4">
                    Generate tags for your <br /> Instagram posts
                </h1>

                <p className="text-gray-400 mb-6">
                    Find trending hashtags for Instagram growth 🚀
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center bg-[#111] border border-gray-700 rounded-xl sm:rounded-full p-2 max-w-xl mx-auto gap-2">
                    ...
                    <input
                        ...
                        placeholder="Enter keyword (e.g. reels, travel, fitness)"
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="bg-white text-black px-5 py-2 rounded-full text-sm flex items-center gap-2"
                    >
            ...
            <div className="max-w-5xl mx-auto mt-20">
                ...
                <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-400">
                    ...
                    <div>
                        ...
                        <p>Paste them into your Instagram post.</p>
                    </div>
                </div>
            </div>

            {/* FAQ */}
            <FAQ data={instagramFAQ} />
        </div>
    );
}